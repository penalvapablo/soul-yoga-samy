      ...
      <div className={styles.desktop__container}>
        <div className={styles.desktop__container__right}>
          <p className={styles.text}>Soy Samy Conti, tengo 37 años, Soy Argentina y vivo en Valencia hace 10 años. Soy licenciada en administración de empresas y me he
            ...
            es ahí cuando mágicamente sentí que quiero dedicarme al bienestar y poder transmitirlo a las personas... y Así nació  <b className={styles.bold}> Soul Yoga Samy</b>.
